...
function (_React$Component) {
  ...
  function MonthView() {
    ...
    _this.readerDateHeading = function (_ref) {
      ...
      var isCurrent = _dates.default.eq(date, currentDate, 'day'); // let drilldownView = getDrilldownView(date)
      ...
      return _react.default.createElement("div", (0, _extends2.default)({}, props, {
        ...
        label: label,
        date: date // drilldownView={drilldownView}
        ,
        isOffRange: isOffRange // onDrillDown={e => this.handleHeadingClick(date, drilldownView, e)}
