    ...
    return _react.default.createElement("div", {
      ...
      return _react.default.createElement(Wrapper, {
        ...
        onClick: function onClick() {
          return onNavigate(null, date);
        },
        className: (0, _classnames.default)('rbc-day-bg', className, _dates.default.eq(date, currentDate, 'day') && 'rbc-selected-cell', _dates.default.eq(date, current, 'day') && 'rbc-today', currentDate && _dates.default.month(currentDate) !== _dates.default.month(date) && 'rbc-off-range-bg')
      }));
    }));
  };
