...
var DateContentRow =
  ...
  (function(_React$Component) {
    ...
    _proto.getRowLimit = function getRowLimit() {
      var eventHeight = 33 // let eventHeight = getHeight(this.eventRow)

      var headingHeight = this.headingRow ? 20 : 0 // let headingHeight = this.headingRow ? getHeight(this.headingRow) : 0
